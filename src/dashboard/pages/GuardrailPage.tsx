...
const generalFields: FormField[] = [
  { key: 'enabled', label: 'Enable Guardrail', type: 'toggle', description: 'Scan tool calls and messages for policy violations.' },
      ...
      {!loading && tab === 'overview' && (
        <>
          <div class="grid-3 mb-16">
            <StatCard label="Status" value={config.enabled ? (config.dryRunMode ? 'Dry-Run' : 'Enforcing') : 'Disabled'} />
