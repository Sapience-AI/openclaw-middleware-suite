...
// Format-valid fake fixtures — every "value" below is intentionally shaped
// to match its detector's regex but is NOT a real credential. The body of
// each value spells out FAKE/EXAMPLE/NOT_REAL so a human reading the file
// recognizes the intent without having to consult a docstring.
const prefixTests = [
  { name: 'Anthropic key', value: 'sk-ant-FAKE_KEY_FOR_TESTS', pattern: /\bsk-ant-[A-Za-z0-9_-]{16,}\b/ },
  { name: 'HuggingFace token', value: 'hf_FAKE_KEY_FOR_TESTS_TT', pattern: /\bhf_[A-Za-z0-9_-]{16,}\b/ },
  { name: 'Slack token', value: 'xoxb-FAKE-SLACK-TOKEN-TST', pattern: /\bxox[bpras]-[A-Za-z0-9_-]{16,}\b/ },
  { name: 'GitHub PAT', value: 'github_pat_FAKE_PAT_FOR_TESTS_NOTREAL', pattern: /github_pat_[a-zA-Z0-9_]{22,}/ },
  { name: 'Stripe live key', value: 'sk_live_FAKEKEYFAKEKEYFAKEKEY12', pattern: /[sr]k[-_](?:live|test)[-_][a-zA-Z0-9]{20,}/ },
  { name: 'SendGrid key', value: 'SG.FAKE_SENDGRID_KEY_TEST.FAKE_FAKE_FAKE_FAKE_NOT_A_REAL_TOKEN_FAKETSX', pattern: /SG\.[a-zA-Z0-9_-]{22}\.[a-zA-Z0-9_-]{43}/ },
  { name: 'npm token', value: 'npm_FAKEFAKEFAKEFAKEFAKEFAKEFAKEFAKEFAKE', pattern: /npm_[a-zA-Z0-9]{36,}/ },
  { name: 'GCP key', value: 'AIzaSy_FAKE_FAKE_FAKE_FAKE_FAKE_NOTREAL', pattern: /AIza[0-9A-Za-z\-_]{35}/ },
  { name: 'Private key header', value: '-----BEGIN RSA PRIVATE KEY-----', pattern: /-----BEGIN\s+(?:RSA|OPENSSH|EC|DSA|PGP)?\s*PRIVATE\s+KEY-----/ },
  { name: 'JWT token', value: 'eyJhbGciOiJIUzI1NiJ9.eyJGQUtFIjoiVE9LRU4ifQ.FAKE_SIGNATURE_NOT_VALID_NOT_A_REAL_JWT', pattern: /eyJ[a-zA-Z0-9_-]{10,}\.eyJ[a-zA-Z0-9_-]{10,}\.[a-zA-Z0-9_-]+/ },
  { name: 'DB connection', value: 'mongodb://FAKE_USER:FAKE_PASSWORD@db.example.com:27017/prod', pattern: /(?:mongodb|postgresql|mysql|mssql|redis|amqp):\/\/[^\s]+:[^\s]+@[^\s]+/ },
];
